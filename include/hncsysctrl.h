...
//
//////////////////////////////////////////////////////////////////////////
HNCAPI Bit32 HNC_SysCtrlSelectProg(Bit32 ch, Bit8 *name, Bit16 clientNo = 0);

/////////////////////////////////////////////////////////////////////////
HNCAPI Bit32 HNC_SysCtrlLoadProg(Bit32 ch, Bit8 *name, Bit16 clientNo);
...
///////////////////////////////////////////////////////////////////////////////
//
//    Bit32 HNC_SysCtrlMdiTry(Bit32 ch)
//
//    功能：
//            测试MDI能否开启
//
...
//
//////////////////////////////////////////////////////////////////////////
extern Bit32 HNC_SysCtrlMdiTry(Bit32 ch);

///////////////////////////////////////////////////////////////////////////////
//
//    Bit32 HNC_SysCtrlMdiReq(Bit32 ch)
//
//    功能：
//            MDI请求
//
...
//
//////////////////////////////////////////////////////////////////////////
extern Bit32 HNC_SysCtrlMdiReq(Bit32 ch);

///////////////////////////////////////////////////////////////////////////////
//
//    Bit32 HNC_SysCtrlMdiOpen(void)
//
//    功能：
//            MDI开启
//
...
//
//////////////////////////////////////////////////////////////////////////
extern Bit32 HNC_SysCtrlMdiOpen(void);

///////////////////////////////////////////////////////////////////////////////
//
//    Bit32 HNC_SysCtrlMdiUpdate(Bit32 rowNum)
//
//    功能：
//            更新MDI数据
//
...
//
//////////////////////////////////////////////////////////////////////////
extern Bit32 HNC_SysCtrlMdiUpdate(Bit32 rowNum);

///////////////////////////////////////////////////////////////////////////////
//
//    Bit16 HNC_SysCtrlMdiGetBlk(Bit64 *pos, Bit32 *msft, Bit64 *ijkr)
//
//    功能：
//            获取MDI数据
//
...
//
//////////////////////////////////////////////////////////////////////////
extern Bit16 HNC_SysCtrlMdiGetBlk(Bit64 *pos, Bit32 *msft, Bit64 *ijkr);

///////////////////////////////////////////////////////////////////////////////
//
//    Bit32 HNC_SysCtrlMdiClear(void)
//
//    功能：
//            MDI清除
//
...
//
//////////////////////////////////////////////////////////////////////////
extern Bit32 HNC_SysCtrlMdiClear(void);

///////////////////////////////////////////////////////////////////////////////
//
//    Bit32 HNC_SysCtrlMdiStop(void)
//
//    功能：
//            MDI停止
//
...
//
//////////////////////////////////////////////////////////////////////////
extern Bit32 HNC_SysCtrlMdiStop(void);

///////////////////////////////////////////////////////////////////////////////
//
//    Bit32 HNC_SysCtrlMdiClose(void)
//
//    功能：
//            MDI关闭
//
...
//
//////////////////////////////////////////////////////////////////////////
extern Bit32 HNC_SysCtrlMdiClose(void);
